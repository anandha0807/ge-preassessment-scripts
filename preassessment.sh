...
{   
    ...
    do
        ...
        (
                ...
                and u.Guest = 1
                and u.AccountID is null
        ) a;" -s , -W -k1 > Output/"$agid"/"$acc"/ge-"$name"_userid.csv
        
        sed -e 's/-,//g;s/-//g;s///g;/^$/d' Output/"$agid"/"$acc"/ge-"$name"_userid.csv > Final_CSV/"$agid"/"$acc"/ge-"$name"_userid.csv
        ...
        group by ss.SavedSearchID, ss.OwnerID,ss.IsHidden,acc.AccountID" -s , -W -k1 > Output/"$agid"/"$acc"/ge-"$name"_user_saved_searchid.csv
        
        sed -e 's/-,//g;s/-//g;s///g;/^$/d' Output/"$agid"/"$acc"/ge-"$name"_user_saved_searchid.csv > Final_CSV/"$agid"/"$acc"/ge-"$name"_user_saved_searchid.csv
        ...
        where acc.AccountID = '$acc' and j.DeletedOn is null and jf.DeletedOn is null" -s , -W -k1 > Output/"$agid"/"$acc"/ge-"$name"_Jobfolderid.csv
        
        sed -e 's/-,//g;s/-//g;s///g;/^$/d' Output/"$agid"/"$acc"/ge-"$name"_Jobfolderid.csv > Final_CSV/"$agid"/"$acc"/ge-"$name"_Jobfolderid.csv
        ...
        where  acc.AccountID = '$acc'  and a.DeletetedOn is null and j.DeletedOn is null" -s , -W -k1  > Output/"$agid"/"$acc"/ge-"$name"_assetid.csv
        
        sed -e 's/-,//g;s/-//g;s///g;/^$/d' Output/"$agid"/"$acc"/ge-"$name"_assetid.csv > Final_CSV/"$agid"/"$acc"/ge-"$name"_assetid.csv
        ...
        group by acc.AccountID,a.AssetID, ad.AssetDerivativeID, ad.AssetTypeCd" -s , -W -k1 > Output/"$agid"/"$acc"/ge-"$name"_Asset_derivative_id.csv
        
        sed -e 's/-,//g;s/-//g;s///g;/^$/d' Output/"$agid"/"$acc"/ge-"$name"_Asset_derivative_id.csv > Final_CSV/"$agid"/"$acc"/ge-"$name"_Asset_derivative_id.csv
        ...
        where acc.AccountID = '$acc' and a.DeletetedOn is null and j.DeletedOn is null order by a.AssetID asc" -s , -W -k1 > Output/"$agid"/"$acc"/ge-"$name"_asset_metadataid.csv
        
        sed -e 's/-,//g;s/-//g;s///g;/^$/d' Output/"$agid"/"$acc"/ge-"$name"_asset_metadataid.csv > Final_CSV/"$agid"/"$acc"/ge-"$name"_asset_metadataid.csv
        ...
        group by acc.AccountID,am.AssetMarkupId, a.AssetID order by a.AssetID asc" -s , -W -k1 > Output/"$agid"/"$acc"/ge-"$name"_asset_markupid.csv
        
        sed -e 's/-,//g;s/-//g;s///g;/^$/d' Output/"$agid"/"$acc"/ge-"$name"_asset_markupid.csv > Final_CSV/"$agid"/"$acc"/ge-"$name"_asset_markupid.csv
        ...
        where a.AccountID = '$acc' AND j.DeletedOn is null and aa.DeletetedOn is null" -s , -W -k1 > Output/"$agid"/"$acc"/ge-"$name"_asset_ratingid.csv
        
        sed -e 's/-,//g;s/-//g;s///g;/^$/d' Output/"$agid"/"$acc"/ge-"$name"_asset_ratingid.csv > Final_CSV/"$agid"/"$acc"/ge-"$name"_asset_ratingid.csv
        ...
        where acc.AccountID = '$acc' and a.DeletetedOn is null and j.DeletedOn is null and nh.ApprovalGalleryUserID is NULL" -s , -W -k1 > Output/"$agid"/"$acc"/ge-"$name"_asset_note_historyid.csv
        
        sed -e 's/-,//g;s/-//g;s///g;/^$/d' Output/"$agid"/"$acc"/ge-"$name"_asset_note_historyid.csv > Final_CSV/"$agid"/"$acc"/ge-"$name"_asset_note_historyid.csv
        ...
        group by l.lightboxid,acc.AccountID" -s , -W -k1 > Output/"$agid"/"$acc"/ge-"$name"_lightbox_id.csv
        
        sed -e 's/-,//g;s/-//g;s///g;/^$/d' Output/"$agid"/"$acc"/ge-"$name"_lightbox_id.csv > Final_CSV/"$agid"/"$acc"/ge-"$name"_lightbox_id.csv
        ...
        group by lg.lightboxgroupid,acc.AccountID" -s , -W -k1 > Output/"$agid"/"$acc"/ge-"$name"_lightbox_groupid.csv
        
        sed -e 's/-,//g;s/-//g;s///g;/^$/d' Output/"$agid"/"$acc"/ge-"$name"_lightbox_groupid.csv > Final_CSV/"$agid"/"$acc"/ge-"$name"_lightbox_groupid.csv
        ...
        where acc.AccountID = '$acc' AND acc.DeletedOn is null AND l.DeletedOn is null" -s , -W -k1 > Output/"$agid"/"$acc"/ge-"$name"_lightbox_commentid.csv
        
        sed -e 's/-,//g;s/-//g;s///g;/^$/d' Output/"$agid"/"$acc"/ge-"$name"_lightbox_commentid.csv > Final_CSV/"$agid"/"$acc"/ge-"$name"_lightbox_commentid.csv
        ...
        where acc.AccountID = '$acc' and acc.DeletedOn is null AND l.DeletedOn is null  
        order by i.InvitationID" -s , -W -k1 > Output/"$agid"/"$acc"/ge-"$name"_lightbox_invitationid.csv
        
        sed -e 's/-,//g;s/-//g;s///g;/^$/d' Output/"$agid"/"$acc"/ge-"$name"_lightbox_invitationid.csv > Final_CSV/"$agid"/"$acc"/ge-"$name"_lightbox_invitationid.csv
        ...
        order by a.assetid" -s , -W -k1 > Output/"$agid"/"$acc"/ge-"$name"_assetHistory_item_TypeID.csv
        
        sed -e 's/-,//g;s/-//g;s///g;/^$/d' Output/"$agid"/"$acc"/ge-"$name"_assetHistory_item_TypeID.csv > Final_CSV/"$agid"/"$acc"/ge-"$name"_assetHistory_item_TypeID.csv
        ...
        inner join AssetMetadata am on am.AssetID = a.AssetID
        where acc.AccountID = '$acc' and a.DeletetedOn is null and j.DeletedOn is null
        AND am.MetadataPropertyID  NOT IN (60,62,63,64,65,78,79,80,81,82,83,84,85,86,87,88,89,90,91,92,93,94,95,96,97,98,99,100,13043,13046,13047)" -s , -W -k1 > Output/"$agid"/"$acc"/ge-"$name"_asset_metadataid_mapped.csv
        
        sed -e 's/-,//g;s/-//g;s///g;/^$/d' Output/"$agid"/"$acc"/ge-"$name"_asset_metadataid_mapped.csv > Final_CSV/"$agid"/"$acc"/ge-"$name"_asset_metadataid_mapped.csv
        ...
        inner join AssetMetadata am on am.AssetID = a.AssetID
        where acc.AccountID = '$acc' and a.DeletetedOn is null and j.DeletedOn is null
        AND am.MetadataPropertyID  IN (60,62,63,64,65,78,79,80,81,82,83,84,85,86,87,88,89,90,91,92,93,94,95,96,97,98,99,100,13043,13046,13047)" -s , -W -k1 > Output/"$agid"/"$acc"/ge-"$name"_asset_metadataid_unmapped.csv
        
        sed -e 's/-,//g;s/-//g;s///g;/^$/d' Output/"$agid"/"$acc"/ge-"$name"_asset_metadataid_unmapped.csv > Final_CSV/"$agid"/"$acc"/ge-"$name"_asset_metadataid_unmapped.csv
        ...
        where acc.AccountID= '$acc' and j.deletedon is null and a.DeletetedOn is null and RIGHT(a.filename, 3) in ('.db', '(1)', '019', 'cof', 'cos', 'cot', 'eip', 'MOV', 'mp4', 'pdf', 'xmp')" -s , -W -k1 > Output/"$agid"/"$acc"/ge-"$name"_unsupported_files.csv 
        
        sed -e 's/-,//g;s/-//g;s///g;/^$/d' Output/"$agid"/"$acc"/ge-"$name"_unsupported_files.csv > Final_CSV/"$agid"/"$acc"/ge-"$name"_unsupported_files.csv
        ...
        a.AccountID,a.AccountName
        order by ag.AccountGroupID,a.AccountID;" -s , -W -k1 > Output/"$agid"/"$acc"/ge-"$name"_Watermarks.csv
        
        sed -e 's/-,//g;s/-//g;s///g;/^$/d' Output/"$agid"/"$acc"/ge-"$name"_Watermarks.csv > Final_CSV/"$agid"/"$acc"/ge-"$name"_Watermarks.csv
        ...
        where a.DeletedOn is null and a.AccountID=@AccountID" -s , -W -k1 > Output/"$agid"/"$acc"/ge-"$name"_WatermarkAssets.csv
        
        sed -e 's/-,//g;s/-//g;s///g;/^$/d' Output/"$agid"/"$acc"/ge-"$name"_WatermarkAssets.csv > Final_CSV/"$agid"/"$acc"/ge-"$name"_WatermarkAssets.csv
        ...
        where a.AccountID=@AccountID" -s , -W -k1 > Output/"$agid"/"$acc"/ge-"$name"_Watermark_Detail.csv
        
        sed -e 's/-,//g;s/-//g;s///g;/^$/d' Output/"$agid"/"$acc"/ge-"$name"_Watermark_Detail.csv > Final_CSV/"$agid"/"$acc"/ge-"$name"_Watermark_Detail.csv
        ...
        a.LightboxID,LightboxName,ExpirationDate,CreatorID,a.CreatedBy,[Role of created by user],[Number of recipients],[Recipient Users Details],
        IsWatermarkEnabled,WatermarkType                                        
        order by LightboxID" -s , -W -k1 > Output/"$agid"/"$acc"/ge-"$name"_LightBox_Details.csv
        
        sed -e 's/-,//g;s/-//g;s///g;/^$/d' Output/"$agid"/"$acc"/ge-"$name"_LightBox_Details.csv > Final_CSV/"$agid"/"$acc"/ge-"$name"_LightBox_Details.csv
        ...
        group by 
        AccountGroupID,AccountGroupName,AccountID,AccountName,a.ApprovalGalleryID,ApprovalGalleryName,ExpirationDate,CreatorID,a.CreatedBy,[Role of created by user],[Number of recipients],[Recipient Users Details],
        IsWatermarkEnabled,WatermarkType;" -s , -W -k1 > Output/"$agid"/"$acc"/ge-"$name"_ApprovalGallery.csv
        
        sed -e 's/-,//g;s/-//g;s///g;/^$/d' Output/"$agid"/"$acc"/ge-"$name"_ApprovalGallery.csv > Final_CSV/"$agid"/"$acc"/ge-"$name"_ApprovalGallery.csv
        ...
        ( 
                ...
                or 
                agc.LightboxID is not null
        )" -s , -W -k1 > Output/"$agid"/"$acc"/ge-"$name"_ApprovalGallery_HashNotes_1.csv
        
        sed -e 's/-,//g;s/-//g;s///g;/^$/d' Output/"$agid"/"$acc"/ge-"$name"_ApprovalGallery_HashNotes_1.csv > Final_CSV/"$agid"/"$acc"/ge-"$name"_ApprovalGallery_HashNotes_1.csv
        ...
        ( -- should has asset source
                ...
                or 
                agc.LightboxID is not null
        )" -s , -W -k1 > Output/"$agid"/"$acc"/ge-"$name"_ApprovalGallery_HashNotes_0.csv
        
        sed -e 's/-,//g;s/-//g;s///g;/^$/d' Output/"$agid"/"$acc"/ge-"$name"_ApprovalGallery_HashNotes_0.csv > Final_CSV/"$agid"/"$acc"/ge-"$name"_ApprovalGallery_HashNotes_0.csv
        ...
        where a.DeletedOn is null and u.DeletedOn is null and a.AccountID=@AccountID and j.DeletedOn is null and jf.DeletedOn is null" -s , -W -k1 > Output/"$agid"/"$acc"/ge-"$name"_project-assignments.csv
        
        sed -e 's/-,//g;s/-//g;s///g;/^$/d' Output/"$agid"/"$acc"/ge-"$name"_project-assignments.csv > Final_CSV/"$agid"/"$acc"/ge-"$name"_project-assignments.csv
        ...
        inner join AccountGroup ag on a.AccountGroupID=ag.AccountGroupID" -s , -W -k1 > Output/"$agid"/"$acc"/ge-"$name"_comment_assetsid-mappings.csv
        
        sed -e 's/-,//g;s/-//g;s///g;/^$/d' Output/"$agid"/"$acc"/ge-"$name"_comment_assetsid-mappings.csv > Final_CSV/"$agid"/"$acc"/ge-"$name"_comment_assetsid-mappings.csv
        ...
        where u.guest = 1
        order by i.invitationid desc" -s , -W -k1 > Output/"$agid"/"$acc"/ge-"$name"_Lightbox_Top_Invitations.csv
        
        sed -e 's/-,//g;s/-//g;s///g;/^$/d' Output/"$agid"/"$acc"/ge-"$name"_Lightbox_Top_Invitations.csv > Final_CSV/"$agid"/"$acc"/ge-"$name"_Lightbox_Top_Invitations.csv
        ...
        where u.UserID in (select UserID from @ActiveUsers)" -s , -W -k1 > Output/"$agid"/"$acc"/ge-"$name"_Talent_Users.csv
        
        sed -e 's/-,//g;s/-//g;s///g;/^$/d' Output/"$agid"/"$acc"/ge-"$name"_Talent_Users.csv > Final_CSV/"$agid"/"$acc"/ge-"$name"_Talent_Users.csv
        ...
        UNPIVOT(
                        ...
                        FOR Header IN ( [Total],[Account Watermark], [Text Account Watermark],[Image Account Watermark]
                                        ,[Username Watermark])
                        ) AS RESULT;" -s , -W -k1 > Output/"$agid"/"$acc"/ge-"$name"_Watermark_Summary.csv
        
        sed -e 's/-,//g;s/-//g;s///g;/^$/d' Output/"$agid"/"$acc"/ge-"$name"_Watermark_Summary.csv > Final_CSV/"$agid"/"$acc"/ge-"$name"_Watermark_Summary.csv
        ...
        where uj.UserID in (select UserID from @ActiveUsers)" -s , -W -k1 > Output/"$agid"/"$acc"/ge-"$name"_User_JobAssginments.csv
        
        sed -e 's/-,//g;s/-//g;s///g;/^$/d' Output/"$agid"/"$acc"/ge-"$name"_User_JobAssginments.csv > Final_CSV/"$agid"/"$acc"/ge-"$name"_User_JobAssginments.csv
...
echo "------------------Repotrs Completed for $f accounts------------------------"